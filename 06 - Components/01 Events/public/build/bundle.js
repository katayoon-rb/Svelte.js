...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 15, 2, 298);
    			add_location(button0, file, 16, 2, 324);
    			add_location(button1, file, 17, 2, 376);
    			add_location(article, file, 14, 0, 286);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(button0, "click", /*addToCart*/ ctx[1], false, false, false, false),
    					listen_dev(button1, "click", /*deleteProduct*/ ctx[2], false, false, false, false)
    				];
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	return [productTitle, addToCart, deleteProduct];
    }
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Product, addToCart, deleteProduct });
    	return [];
    }
