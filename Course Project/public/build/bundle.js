    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-14bvbnh");
    			add_location(h1, file$3, 13, 4, 224);
    			attr_dev(h2, "class", "svelte-14bvbnh");
    			add_location(h2, file$3, 14, 4, 245);
    			attr_dev(p0, "class", "svelte-14bvbnh");
    			add_location(p0, file$3, 15, 4, 269);
    			attr_dev(header, "class", "svelte-14bvbnh");
    			...
    			attr_dev(img, "class", "svelte-14bvbnh");
    			add_location(img, file$3, 18, 4, 324);
    			attr_dev(div0, "class", "image svelte-14bvbnh");
    			add_location(div0, file$3, 17, 2, 300);
    			attr_dev(p1, "class", "svelte-14bvbnh");
    			add_location(p1, file$3, 21, 4, 396);
    			attr_dev(div1, "class", "content svelte-14bvbnh");
    			add_location(div1, file$3, 20, 2, 370);
    			attr_dev(footer, "class", "svelte-14bvbnh");
    			add_location(footer, file$3, 23, 2, 428);
    			attr_dev(article, "class", "svelte-14bvbnh");
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(form, file, 55, 2, 1620);
    			attr_dev(main, "class", "svelte-1ab3vfs");
    			add_location(main, file, 54, 0, 1611);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
