<script>
  ...
  function submitForm() {
    ...
    if (id) {
      fetch(
        `https://svelte-course-prj-default-rtdb.firebaseio.com/meetups/${id}.json`,
        {
          method: "PATCH",
      ...
      fetch(
        "https://svelte-course-prj-default-rtdb.firebaseio.com/meetups.json",
        {
          method: "POST",
...
<Modal title="Edit Meetup Data" on:cancel>
  <form on:submit={submitForm}>
    <TextInput
      ...
      label="Title"
      valid={titleValid}
      validityMsg="Please enter a valid title."
      value={title}
